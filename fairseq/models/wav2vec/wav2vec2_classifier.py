...
@dataclass
class Wav2Vec2ClassifierConfig(FairseqDataclass):
    w2v_path: str = field(
...
@dataclass
class Wav2Vec2Seq2SeqConfig(Wav2Vec2ClassifierConfig):
...
class Wav2Vec2Seq2SeqModel(FairseqEncoderDecoderModel):
    ...
    @classmethod
    def build_encoder(cls, cfg: Wav2Vec2ClassifierConfig):
...
class Wav2VecEncoder(FairseqEncoder):
    def __init__(self, cfg: Wav2Vec2ClassifierConfig, tgt_dict=None):
...
class Net(nn.Module):
    def __init__(self, cfg: Wav2Vec2Seq2SeqConfig, embed_tokens):
        super().__init__()
        ...
        #input_embed_dim = embed_tokens.embedding_dim
        input_embed_dim = 768
        self.fc1 = nn.Linear(input_embed_dim, 192)
