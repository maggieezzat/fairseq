...
### a) Insall MKL
    Use the following commands or follow this script https://github.com/eddelbuettel/mkl4deb/blob/master/script.sh
    - `cd /tmp`
...
### b) Install ArrayFire
    - `wget 'http://arrayfire.s3.amazonaws.com/3.6.1/ArrayFire-no-gl-v3.6.1_Linux_x86_64.sh'`
    - `sudo sh ArrayFire-no-gl-v3.6.1_Linux_x86_64.sh`
